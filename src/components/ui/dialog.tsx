  ...
  return (
    <BaseDialog.Root open={open} onOpenChange={onOpenChange}>
      <BaseDialog.Portal>
        ...
        <BaseDialog.Popup className="fixed inset-x-4 bottom-4 z-50 mx-auto max-w-xl rounded-2xl bg-white p-6 text-[#1c1c1e] shadow-[0_25px_60px_rgba(0,0,0,0.16)] md:inset-x-0 md:bottom-auto md:top-1/2 md:-translate-y-1/2">
